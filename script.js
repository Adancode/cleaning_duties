...
function resetDuties() {
    ...
    // }
    duties.push("Check downstairs & upstairs hallway air filters. Replace filters if needed (filters in pantry, install with arrow pointing in direction of airflow/into wall). Use small step ladder in pantry if needed.");
    tenants.push("Adam Camacho");
